...
const AdminDashboard = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-900 p-6 sm:px-2 transition-all duration-300 ease-in-out">
        {/* Header */}
        <div className="mb-8">
          <div className="flex flex-wrap sm:flex-col items-center justify-between gap-4 sm:gap-2">
            <div className="flex-1 min-w-[220px]">
              <h1 className="text-3xl sm:text-lg font-bold text-white mb-2">
                Dashboard Overview
              </h1>
              <p className="text-slate-400 text-base sm:text-sm">
                Welcome back, {userData?.firstName || 'User'}! Here's your financial summary.
              </p>
            </div>
            <div className="flex flex-wrap gap-3 sm:w-full sm:block">
              <button
                onClick={handleRefreshData}
                disabled={refreshing}
                className="bg-slate-800 hover:bg-slate-700 text-white px-4 py-2 sm:px-2 sm:py-2 rounded-lg font-medium transition-colors duration-200 flex items-center gap-2 w-fit disabled:opacity-50"
              >
              ...
              <select 
                ...
                className="bg-slate-800 text-white px-4 py-2 sm:px-2 sm:py-2 rounded-lg border border-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all duration-200"
              >
                <option value="7d">Last 7 days</option>
                <option value="30d">Last 30 days</option>
                <option value="90d">Last 90 days</option>
              </select>
              <button className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 sm:px-2 sm:py-2 rounded-lg font-medium transition-colors duration-200 flex items-center gap-2 w-fit">
                <Download size={16} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50">
            <div className="p-6 border-b border-slate-700/50 flex flex-col sm:flex-col">
            ...
            <div className="p-6">
              {accounts.length === 0 ? (
                ...
                <div className="space-y-4">
                  {accounts.map((account) => (
                    <div key={account._id} className="group flex flex-wrap sm:flex-col items-center justify-between p-4 bg-slate-900/50 rounded-lg border border-slate-700/30 hover:border-slate-600 transition-all duration-200 hover:bg-slate-900/70">
              ...
              {/* Account Summary */}
              {accounts.length > 0 && (
                <div className="mt-6 grid grid-cols-2 sm:grid-cols-1 gap-4">
            ...
            {recentTransactions.length === 0 ? (
              ...
              <div className="space-y-4">
                {recentTransactions.map((transaction) => (
                  <div key={transaction._id} className="group flex flex-wrap sm:flex-col items-center justify-between p-4 bg-slate-900/30 rounded-lg border border-slate-700/30 hover:border-slate-600 hover:bg-slate-900/50 transition-all duration-200">
                    <div className="flex items-center gap-4">
                      <div className={`p-3 rounded-xl ${
